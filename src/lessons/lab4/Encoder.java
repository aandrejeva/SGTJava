...
/**
Develop an application that accepts a one word message from the user as input. The application should then encode
the word and output the encoded word by reversing the word and replacing all of the vowels with numbers as
...
public class Encoder {
	...
	public static void main(String[] args) {
		...
		for(int i = len - 1; i >= 0; i-=1) {
			//retrieve the char from the word located at the index i, and store it in the variable l
			char l = word.charAt(i);
			if(l == 'a' || l == 'A') {
				//if chal l = a or A, add 1 to the encoded word
				sb.append(1);
			}else if (l == 'i' || l == 'I') { 
				sb.append(9);
			}else if (l == 'e' || l == 'E') { 
				...
				sb.append(21);
			}else{ //if the letter not vowels add the letter itself to the encoded word
				sb.append(l);
			}
		}// end for
